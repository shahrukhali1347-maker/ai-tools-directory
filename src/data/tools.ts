...
export const aiTools: AITool[] = [
  ...
  createTool('151', 'Mistral Le Chat', 'mistral-le-chat', 'Open-weight AI assistant', 'Mistral Le Chat is powered by Mistral AI models. Fast, open-weight models for conversation, coding, and analysis.', 'chatbots', ['open-weight', 'fast'], ['open-weight', 'fast', 'coding', 'analysis', 'european-ai'], 'https://chat.mistral.ai', 'freemium', true, 15, ['web', 'api'], 4.6, 34000, true, true),
  ...
  createTool('154', 'Llama by Meta', 'llama', 'Open-source AI by Meta', 'Meta Llama is an open-source large language model family. Run locally or deploy in the cloud with full customization.', 'chatbots', ['open-source', 'local'], ['open-source', 'local', 'meta', 'customizable', 'self-hosted'], 'https://llama.meta.com', 'free', true, 0, ['web', 'desktop', 'api'], 4.6, 89000, true, true),
  createTool('155', 'Copilot by Microsoft', 'microsoft-copilot', 'AI companion for Microsoft 365', 'Microsoft Copilot brings AI assistance across Windows, Edge, Office, and Bing. Integrated into the Microsoft ecosystem.', 'chatbots', ['microsoft', 'productivity'], ['microsoft', 'productivity', 'office', 'windows', 'bing'], 'https://copilot.microsoft.com', 'freemium', true, 20, ['web', 'desktop', 'ios', 'android'], 4.6, 178000, true, false),
  createTool('156', 'Grok', 'grok', 'AI by xAI', 'Grok by xAI provides real-time information access and witty responses. Integrated with X (Twitter) for current events.', 'chatbots', ['real-time', 'social'], ['real-time', 'xai', 'twitter', 'current-events', 'witty'], 'https://grok.x.ai', 'subscription', false, 8, ['web', 'ios', 'android'], 4.4, 56000, true, true),
  ...
  createTool('161', 'Krea AI', 'krea-ai', 'Real-time AI image generation', 'Krea AI generates images in real-time as you type or draw. Instant visual feedback with AI-powered creativity.', 'image-generation', ['real-time', 'interactive'], ['real-time', 'interactive', 'drawing', 'instant', 'creative'], 'https://krea.ai', 'freemium', true, 10, ['web'], 4.6, 34000, true, true),
  createTool('162', 'Pika', 'pika', 'AI image and video creation', 'Pika creates and edits images and short videos with AI. Transform ideas into visual content with simple text prompts.', 'image-generation', ['video', 'creative'], ['image-video', 'creative', 'prompts', 'editing', 'generation'], 'https://pika.art', 'freemium', true, 8, ['web'], 4.5, 28000, true, true),
  ...
  createTool('173', 'Devin', 'devin', 'AI software engineer', 'Devin by Cognition is an autonomous AI software engineer. Plans, codes, debugs, and deploys entire projects independently.', 'code-assistance', ['autonomous', 'full-stack'], ['autonomous', 'full-stack', 'planning', 'debugging', 'deployment'], 'https://cognition.ai', 'subscription', false, 500, ['web'], 4.5, 45000, true, true),
  ...
  createTool('179', 'Codium AI', 'codium-ai', 'AI test generation', 'Codium AI generates meaningful tests for your code. Understand behavior, find bugs, and ensure quality automatically.', 'code-assistance', ['testing', 'quality'], ['testing', 'quality', 'test-generation', 'bugs', 'behavior'], 'https://codium.ai', 'freemium', true, 19, ['desktop', 'api'], 4.5, 18000, false, false),
